...
from api.sparse_torch import CSRMatrix3d, CSCMatrix3d

from torch.utils.cpp_extension import load
bilinear_diag = load(name='bilinear_diag', sources=['api/extension/bilinear_diag/bilinear_diag.cpp',
                                                    'api/extension/bilinear_diag/bilinear_diag_cuda.cu'],
                     extra_include_paths=[
